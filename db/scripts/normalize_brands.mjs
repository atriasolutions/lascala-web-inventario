...
const BRAND_TYPO_MAP = {
  ...
  DIVINEYEANS: 'DIVINE JEANS',
  DIVENEJEANS: 'DIVINE JEANS',
  'DIVINE JEAN': 'DIVINE JEANS',
  'DIVINE YEANS': 'DIVINE JEANS',
  'DIVENE JEANS': 'DIVINE JEANS',
  'DIVNE JEANS': 'DIVINE JEANS',
  'DIVIN JEANS': 'DIVINE JEANS',
  JULLIETA: 'JULIETTA',
  LINIATRE: 'LINEATRE',
  MOHICAN0: 'MOHICANO',
  'LORENZO DI PONTI': 'LORENZO DI PONTTI',
  'LORENZO DI PORTTI': 'LORENZO DI PONTTI',
  LORENZODIPONTI: 'LORENZO DI PONTTI',
  LORENZODIPORTTI: 'LORENZO DI PONTTI',
  LORENZODIPONTTI: 'LORENZO DI PONTTI',
  SYMPONY: 'SYMPHONY',
  NESLEAY: 'NESLAY',
  ZARRA: 'ZARA',
  HM: 'H&M',
