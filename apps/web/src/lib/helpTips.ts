...
export const HELP_TIPS: Record<string, string> = {
  ...
  'nav.caja':
    'Ventas: pistolea o busca, aplica descuentos si hay promo, cobra en Efectivo o Tarjeta y deja el movimiento en esta sucursal y esta caja.',
  'nav.ingresos':
  ...
  'nav.productos':
    'Catálogo: ficha, foto, código LS… y marca. El Precio costo no se inventa acá; vive en Ingresos.',
  'nav.stock':
  ...
  'nav.movimientos':
    'Trazabilidad: cada venta, ingreso, merma o ajuste deja quién, cuándo y cómo cambió el stock. Filtra también por marca.',
  'nav.mermas':
    'Bajas (pérdida o proveedor) y tickets VC…: cambio 1:1 o devolución en efectivo. Vestidos de fiesta suelen ir sin cambio.',
  'nav.gastos':
    'Gastos de la sucursal (arriendo, sueldos, servicios). No mueve stock. Solo Administrador/a.',
  'nav.reportes':
    'Vistas de control y Excel: ventas (Efectivo/Tarjeta), stock, ingresos, gastos, mermas y Pérdida/Ganancia de tomas.',
  'nav.ajustes':
  ...
  'nav.mas':
    'Más pantallas según tu rol. En celular, Administrador/a ve Inicio/Compras/Gastos; piso ve Historial/Productos/Stock/Movimientos.',
  'header.sucursal':
  ...
  'cta.caja.finalizar':
    'Cierra la venta: eliges Efectivo o Tarjeta, descuentos si aplica, y con efectivo indicas con cuánto paga (vuelto o falta). Descuenta stock e imprime si hay impresora.',
  'cta.caja.buscar':
  ...
  'cta.mermas.ticket':
    'Atiende un voucher VC…: cambio 1:1 o devolución en efectivo (deja gasto Devoluciones). Puedes usar cantidad parcial.',
  ...
  'cta.productos.nueva':
    'Crea la ficha (nombre, foto, código, marca). El costo real se carga al ingresar mercadería.',
  'cta.compras.nueva':
    'Registra el documento de compra con Precio costo por línea. Después se recepta en Ingresos.',
  'cta.gastos.nuevo':
    'Anota un gasto operativo de la sucursal. No toca el inventario. Las devoluciones en efectivo ya generan gasto solas.',
  'cta.dashboard.ventas':
    'Atajo a Ventas para cobrar. El resumen de ventas del día está arriba, de esta sucursal.',
  'cta.reportes.excel':
    'Descarga la vista actual (período, sucursal activa y, en Ventas, Efectivo/Tarjeta) en Excel.',
};
