...
function rowAction(status: PurchaseStatus) {
...
export function ComprasListPage() {
  ...
  return (
    <div className="ing-list compras-list">
      <div className="ing-list-workspace">
        <div className="ing-list-main">
          ...
          <div className="ing-filters" role="toolbar" aria-label="Filtros de compras">
            <button
              type="button"
              className={`ing-chip${filters.status === 'all' ? ' is-active' : ''}`}
            ...
            <button
              ...
              onClick={() => setFilters((prev) => ({ ...prev, status: 'pending_reception' }))}
            >
              Pendientes
            </button>
          ...
          <div className="ing-list-scroll" ref={scrollRef}>
            {loading && (
              <div className="ing-skel" aria-busy="true" aria-label="Cargando compras">
        ...
        >
          ...
          >
            ...
            <div className="ing-filter-fields">
              <div className="field">
                <label htmlFor="compra-f-from">Fecha desde</label>
                <input
                  id="compra-f-from"
                  type="date"
                  value={draftDateFrom}
              ...
              <div className="field">
                <label htmlFor="compra-f-to">Fecha hasta</label>
                <input
                  id="compra-f-to"
                  type="date"
                  value={draftDateTo}
              ...
              <div className="field">
                <label htmlFor="compra-f-q">Producto</label>
                <input
                  id="compra-f-q"
                  value={draftQ}
              ...
              <div className="field">
                <label htmlFor="compra-f-status">Estado</label>
                <select
                  id="compra-f-status"
                  value={draftStatus}
                ...
                >
                  ...
                  <option value="pending_reception">Pendiente</option>
